...
export default function Organizers() {
  ...
  return (
    <div className="flex flex-col items-center min-h-screen px-6 py-10 bg-gray-50 w-full">
      <div className="w-full max-w-3xl text-center mb-6">
        <h1 className="text-3xl font-semibold text-gray-900">Organizers</h1>
      </div>
      ...
      <div className="w-full max-w-3xl space-y-4">
        {(() => {
          ...
          if (organizers.length === 0) {
            return (
              <p className="text-center text-gray-600">No organizers found.</p>
            );
          }
          ...
          return organizers.map((org) => {
            ...
            return (
              <div
                key={org._id}
                className="flex items-center justify-between gap-5 p-4 border rounded-lg shadow-sm bg-white"
              >
                ...
                {showFollowBtn && (
                  <Button
                    ...
                    onClick={() =>
                      handleFollowToggle(org._id, org.isFollowing!)
                    }
